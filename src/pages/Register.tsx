...
export const Register = () => {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setLoading(false); // Only stop loading on error, keep it 'loading' state or switch view on success
        }
    };

    return (
        <div className="min-h-screen flex items-center justify-center bg-[#1f2326] p-4">
            <div className="w-full max-w-md bg-[#181b1e] border border-gray-800 rounded-xl shadow-2xl p-8 relative overflow-hidden">
                ...
                {success ? (
                    <div className="flex flex-col items-center justify-center text-center animate-in fade-in zoom-in duration-300 py-4">
                        ...
                        <p className="text-gray-400 mb-6">
                            Veuillez vérifier vos emails pour confirmer votre inscription, ou connectez-vous directement.
                        </p>
                        <button
                    ...
                    <>
                        ...
                        {error && (
                            <div className="bg-red-500/10 border border-red-500/50 text-red-400 p-3 rounded-lg mb-6 flex items-center gap-2 text-sm animate-in slide-in-from-top-2">
                                <AlertCircle size={16} />
                                {error}
                            </div>
                        )}
